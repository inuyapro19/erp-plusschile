                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="btn-group mb-3">
                            <a v-if="tienePermisoAgregarChecklist" href="/checklist-calidad/nuevo"
...
export default {
    ...
    computed: {
        ...
        tienePermisoFirmarChecklist() {
            return this.permisos.includes('Firmar Checklist');
        },
        tienePermisoEditarChecklist() {
            return this.permisos.includes('Editar Checklist');
        },
        tienePermisoAgregarChecklist() {
            return this.permisos.includes('Agregar Checklist');
        },
        formattedBuses() {
    ...
    methods: {
        ...
        getChecklist(page = 1) {
            ...
            let url = '/getchecklistcalidad?option=paginate&' + params.toString();
        ...
        async getAllChecklist() {
            const {data, status} = await axios.get('/getchecklistcalidad?option=all')
            if (status === 200) {
        ...
        async handleExport() {
            try {
                ...
                const urlBase = '/export-checklist?' + params.toString();
        ...
        //getCheckListCalidadIdNegativeResponses
        ...
        sendReport() {
            axios.get('/send-ticket-notification')
                .then(response => {
