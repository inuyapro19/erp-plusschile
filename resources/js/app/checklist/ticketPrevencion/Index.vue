<template xmlns="http://www.w3.org/1999/html">
    <div>
        <CardComponent :title="'Ticket Prevención'">
...
export default {
    ...
    computed: {
        tienePermisoValidarTicket() {
            return this.permisos.includes('Validar Ticket Prevencion');
        },
        tienePermisoEditarTicket() {
            return this.permisos.includes('Editar Ticket Prevencion');
        },
        formattedBuses() {
    ...
    methods: {
        ...
        getTickets(page = 1) {
            ...
            let url = '/ticket-prevencion/get?option=paginate&' + params.toString();
        ...
        async getAllTicket() {
            const {data, status} = await axios.get('/ticket-prevencion/get?option=all')
            if (status === 200) {
