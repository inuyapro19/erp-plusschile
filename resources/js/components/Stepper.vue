        ...
        <div class="card d-flex justify-content-center justify-content-xl-start flex-row-auto w-100 w-xl-300px w-xxl-400px">
            <div class="card-body px-6 px-lg-10 px-xxl-15 py-20">
                ...
                <div class="stepper-nav">
                    <!-- Stepper item -->
                    <div class="stepper-item" :class="{ 'current': index + 1 === currentStep, 'pending': index + 1 !== currentStep}"
                        ...
                        <div class="stepper-wrapper">
                            ...
                            <div class="stepper-label">
                                ...
                                <h3 class="stepper-title">{{ category.name.charAt(0).toUpperCase() + category.name.slice(1).toLowerCase() }}</h3>
...
<!--                <component :is="currentComponent" @step-changed="handleStepChange" @submit-page="submitPage"></component>-->
                    <slot></slot>
                <div class="d-flex flex-stack pt-10">
                    ...
                    <button type="button" class="btn btn-lg btn-light-warning me-3"
                            v-if="currentStep === 1"
                            @click="clearForm">
                        Limpiar
                    </button>
        ...
        clearForm() {
            this.$swal({
                ...
                if (result.isConfirmed) {
                    ...
                    localStorage.clear();
                    this.$swal('Cleared!', 'Your form has been cleared.', 'success');
                }
            });
        },
        submitPage() {
