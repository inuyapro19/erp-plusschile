...
<body>
    <div class="container">
       <div class="cabezera">
           <h4>{{$data['cabezera']['empleador'] ?? ''}}</h4>
           <span>{{$data['cabezera']['rut_empleador'] ?? ''}}</span> <span>{{$data['cabezera']['direccion_empleador'] ?? ''}}</span>
       </div>
       ...
       <div class="linea-doble"></div>
        <div class="datos-laborales">
            <div class="nombre">
                <span>NOMBRE: <span style="font-weight: bold">{{strtoUpper($data['cabezera']['full_name'] ?? '')}}</span></span>
            </div>
            <table style="border: none;width: 100%;text-align: left">
                <tr>
                    <td>RUT:</td>

                    <td>{{$data['cabezera']['rut'] ?? ''}}</td>
                    <td></td>
                    <td></td>
                    <td>TIPO CONTRATO:</td>
                    <td>{{$data['cabezera']['tipo_contrato'] ?? ''}}</td>
                </tr>
                <tr>
                    <td>CARGO:</td>
                    <td>{{$data['cabezera']['cargo'] ?? ''}}</td>
                    <td></td>
                    <td></td>
                    <td>FECHA INGRESO:</td>
                    <td>{{$data['cabezera']['fecha_ingreso'] ?? ''}}</td>
                </tr>
            ...
            <table style="width: 100%;border: none">
                <tr>
                    <td>D/TRABAJADOS:</td>
                    <td>{{$data['cabezera']['dias_trabajados'] ?? ''}}</td>
                    <td>A.F.P</td>
                    <td>AFP {{$data['cabezera']['afp'] ?? ''}}</td>
                    <td>INST.SALUD:</td>
                    <td>{{$data['cabezera']['entidad_salud'] ?? ''}}   {{$data['cabezera']['porcentaje'] ?? ''}}</td>
                </tr>
            </table>
        </div>
                ...
                <tr>
                    <td>
                        ...
                        <table style="width: 100%;text-align: left">
                            ...
                            <tr>
                                <td>SUELDO BASE</td>
                                <td>{{number_format($data['haberes_imponibles']['sueldo_base'],0,'.',',') ?? 0}}</td>
                            </tr>
                            <!--BONOS-->
                            <tr>
                                <td>BONOS</td>
                    ...
                    <td>
                        ...
                        <table style="width: 100%;text-align: left">
                            <tr>
                                <td>Descuentos no Imponibles</td>
                                <td></td>
                            </tr>
                            <tr>
                                <td>T.FONDO PENSION</td>
