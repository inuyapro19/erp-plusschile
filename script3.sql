...
alter table autorizadores
    add constraint autorizadores_ibfk_1
        foreign key (trabajador_id) references trabajadores (id);
...
alter table monto_asignacion_peajes
    add constraint FK_monto_asignacion_peajes_viajes
        foreign key (viaje_id) references viajes (id)
            on update cascade on delete cascade;
...
alter table viajesalidas
    add constraint viajeSalidas_ibfk_1
        foreign key (viaje_id) references viajes (id);
