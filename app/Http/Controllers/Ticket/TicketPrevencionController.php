...
use App\Models\Checklist\TicketPrevencionView;
...
class TicketPrevencionController extends Controller
{
    public function index()
    {
        return view('checklist.ticket.index-prevencion');
    }
    ...
    public function getTicket()
    {
        try {
            ...
            $query = TicketPrevencionView::orderBy('TICKET_ID', 'desc');
            ...
            if (!$user->hasRole(['Jefe Prevencion','Asistente Prevencion','admin'])) {
    ...
    public function sendTicketNotification()
    {
        ...
        Mail::to(['dusan@plusschile.cl','sig@plusschile.cl'])->send(new TicketNotification($checklistData,'Prevención de riesgos'));
